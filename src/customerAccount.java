...
*/
        ...
        buttonGroup.add(r1);buttonGroup.add(r2);buttonGroup.add(r3);buttonGroup.add(r4);buttonGroup.add(r5);buttonGroup.add(r6);
       ...
       /* b9 = new JButton("Supplier_ID");
        ...
        String str = "select * from customer_account";
        ...
        try {
            ...
            table.setBounds(600,200,772,500);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (x.isEmpty()) {
                    ...
                    if (r1.isSelected()) {
                        ...
                        ans = table_search(x,"Customer_name");

                    } else if (r2.isSelected()) {

                        ans = table_search(x,"Phone_number");

                    } else if (r3.isSelected()) {

                        ans = table_search(x,"Particulars");

                    } else if (r4.isSelected()) {

                        ans = table_search(x,"Credit");

                    } else if (r5.isSelected()) {

                        ans = table_search(x,"Debit");

                    } else if (r6.isSelected()) {

                        ans = table_search(x,"Balance");
...
/*
        ...
        b1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               // String ff = t6.getText();
                ...
                String z = "insert into customer_account values('"+a+"','"+b+"','"+c+"','"+d+"','"+ee+"')";
                try {
    ...
    private void table_delete() {
        ...
        String command = "delete from customer_account where Product_name = '"+delete_cell+"'";
    ...
    private ResultSet table_sort(String text, int val) {
        ...
        String command = "select * from customer_account order by "+text+"";
    ...
    private ResultSet table_search(String search_box, String col_name) {
        ...
        ResultSet res = null;
        String command =  "select * from customer_account where "+col_name+" like '"+search_box+"%' ";
        try {
            res = conn.s.executeQuery(command);
    ...
    private void update_table(String old_str, String new_str) {
        ...
        String command = "update customer_account set Customer_name = '"+new_str+"' where Customer_name = '"+old_str+"'  ";
